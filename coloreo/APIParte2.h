...
luego los indices de color el segundo mayor impar, etc hasta terminar con los
impares, y luego pone los indices de color el mayor par, luego el segundo mayor
par, etc. Aca no es necesaria la estructura de G, solo n.*/
